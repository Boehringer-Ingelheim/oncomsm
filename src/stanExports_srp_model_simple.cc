...
#include "stanExports_srp_model_simple.h"

RCPP_MODULE(stan_fit4srp_model_simple_mod) {


    class_<rstan::stan_fit<stan_model, boost::random::ecuyer1988> >("rstantools_model_srp_model_simple")
