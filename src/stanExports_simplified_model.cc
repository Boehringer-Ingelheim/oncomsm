...
#include "stanExports_simplified_model.h"

RCPP_MODULE(stan_fit4simplified_model_mod) {


    class_<rstan::stan_fit<stan_model, boost::random::ecuyer1988> >("rstantools_model_simplified_model")
