...
#include "stanExports_srpc_model.h"

RCPP_MODULE(stan_fit4srpc_model_mod) {


    class_<rstan::stan_fit<stan_model, boost::random::ecuyer1988> >("rstantools_model_srpc_model")
