...
// fast_impute
DataFrame fast_impute(DataFrame df, NumericMatrix p, NumericVector shape_vec, NumericVector scale_vec, NumericVector visit_spacing, int n_sim, int n_groups);
RcppExport SEXP _oncomsm_fast_impute(SEXP dfSEXP, SEXP pSEXP, SEXP shape_vecSEXP, SEXP scale_vecSEXP, SEXP visit_spacingSEXP, SEXP n_simSEXP, SEXP n_groupsSEXP) {
BEGIN_RCPP
    Rcpp::RObject rcpp_result_gen;
    Rcpp::RNGScope rcpp_rngScope_gen;
    Rcpp::traits::input_parameter< DataFrame >::type df(dfSEXP);
    ...
    Rcpp::traits::input_parameter< int >::type n_sim(n_simSEXP);
    Rcpp::traits::input_parameter< int >::type n_groups(n_groupsSEXP);
    rcpp_result_gen = Rcpp::wrap(fast_impute(df, p, shape_vec, scale_vec, visit_spacing, n_sim, n_groups));
    return rcpp_result_gen;
END_RCPP
}
...
static const R_CallMethodDef CallEntries[] = {
    ...
    {"_oncomsm_fast_impute", (DL_FUNC) &_oncomsm_fast_impute, 7},
