...
stan::io::program_reader prog_reader__() {
    ...
    reader.add_event(123, 121, "end", "model_simplified_model");
    return reader;
}
...
public:
    ...
    void ctor_body(stan::io::var_context& context__,
        ...
        try {
            ...
            context__.validate_dims("data initialization", "shape", "double", context__.to_vec(M_groups));
            shape = std::vector<double>(M_groups, double(0));
            ...
            for (size_t i_0__ = 0; i_0__ < shape_i_0_max__; ++i_0__) {
                check_greater_or_equal(function__, "shape[i_0__]", shape[i_0__], stan::math::machine_precision());
            }
