...
"A" and "B".
We start with a fairly vague prior except for the shape which is fixed to 
about 1 (default) in absence of other evidence.
This is required to stabilize inference on the other model parameters.
...
distribution conditional on specific response rates is given below
