...
\tau_{S} \,|\, R = 1 &\sim \operatorname{Weibull}(shape[1], scale[1]) \\
\tau_{S} \,|\, R = 0 &\sim \operatorname{Weibull}(shape[3], scale[3]) \\
\tau_{R} &\sim \operatorname{Weibull}(shape[2], scale[2]) \ .
\end{align}
$$
...
$$
\operatorname{Pr}\big[\,\tau_{S} > t \,\big]  = p\cdot(1 - F_1(t))  + (1 - p)\cdot(1 - F_3(t))\\
$$
...
# TODO: add a plot for progression free survival
```
...
TODO: the plot can go in the standard summary plot
