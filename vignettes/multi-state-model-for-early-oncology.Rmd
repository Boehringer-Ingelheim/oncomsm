...
This concept can be extended to the entire survival function of PFS but
computing the PFS rate at several time steps for a parameter sample and then
integrating over the parameter distribution.
...
ggplot(tbl_pfs_survival) +
  geom_line(aes(x = t, y = pfs, color = group_id)) +
  scale_color_discrete("") +
  labs(x = "t", y = "Pr[no death or progression before t]")
```
