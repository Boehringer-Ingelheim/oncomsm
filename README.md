...
For instance, the [bhmbasket](https://cran.r-project.org/web/packages/bhmbasket/index.html) R package [can be used to define study success based on Bayesian hierarchical models](https://boehringer-ingelheim.github.io/oncomsm/articles/bhmbasket-integration.html).
